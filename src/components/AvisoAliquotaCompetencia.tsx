...
export function AvisoAliquotaCompetencia({
  ...
  return (
    <div className="rounded-xl bg-amber-50 px-4 py-3 text-corpo text-amber-800">
      ...
      <pre className="mt-2 whitespace-pre-wrap font-sans text-rotulo text-amber-900">
        {aviso.passoAPasso}
      </pre>
      {onConfirmar && (
        <button
          ...
          className="mt-3 rounded-xl bg-amber-800 px-4 py-2 text-rotulo font-semibold text-white hover:opacity-90 disabled:opacity-50"
        >
